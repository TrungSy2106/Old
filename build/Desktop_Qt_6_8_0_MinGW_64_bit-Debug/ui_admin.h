...
public:
    ...
    QPushButton *SerUsage1btn_5;
    QPushButton *SerUsage1btn_6;
    ...
    QPushButton *Contractbtn_2;
    QPushButton *Contractbtn_3;
...
"}"));
        ...
        SerUsage1btn_5 = new QPushButton(MI_AD);
        SerUsage1btn_5->setObjectName("SerUsage1btn_5");
        SerUsage1btn_5->setMinimumSize(QSize(0, 30));
        SerUsage1btn_5->setStyleSheet(QString::fromUtf8("QPushButton:checked{\n"
"background-color:white;\n"
"border-radius:3px;\n"
"}"));
        SerUsage1btn_5->setIcon(icon1);
        SerUsage1btn_5->setIconSize(QSize(30, 18));
        SerUsage1btn_5->setCheckable(true);
        SerUsage1btn_5->setAutoExclusive(true);

        verticalLayout_4->addWidget(SerUsage1btn_5);

        SerUsage1btn_6 = new QPushButton(MI_AD);
        SerUsage1btn_6->setObjectName("SerUsage1btn_6");
        SerUsage1btn_6->setMinimumSize(QSize(0, 30));
        SerUsage1btn_6->setStyleSheet(QString::fromUtf8("QPushButton:checked{\n"
"background-color:white;\n"
"border-radius:3px;\n"
"}"));
        SerUsage1btn_6->setIcon(icon1);
        SerUsage1btn_6->setIconSize(QSize(30, 18));
        SerUsage1btn_6->setCheckable(true);
        SerUsage1btn_6->setAutoExclusive(true);

        verticalLayout_4->addWidget(SerUsage1btn_6);
...
"}"));
        ...
        Contractbtn_2 = new QPushButton(MIT_AD);
        Contractbtn_2->setObjectName("Contractbtn_2");
        Contractbtn_2->setMinimumSize(QSize(186, 30));
        Contractbtn_2->setMaximumSize(QSize(16777215, 30));
        Contractbtn_2->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"padding-left :-43px\n"
"}\n"
"QPushButton:checked{\n"
"background-color:white;\n"
"border-radius:3px;\n"
"}"));
        Contractbtn_2->setIcon(icon8);
        Contractbtn_2->setIconSize(QSize(110, 18));
        Contractbtn_2->setCheckable(true);
        Contractbtn_2->setAutoExclusive(true);

        verticalLayout_2->addWidget(Contractbtn_2);

        Contractbtn_3 = new QPushButton(MIT_AD);
        Contractbtn_3->setObjectName("Contractbtn_3");
        Contractbtn_3->setMinimumSize(QSize(186, 30));
        Contractbtn_3->setMaximumSize(QSize(16777215, 30));
        Contractbtn_3->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"padding-left :-43px\n"
"}\n"
"QPushButton:checked{\n"
"background-color:white;\n"
"border-radius:3px;\n"
"}"));
        Contractbtn_3->setIcon(icon8);
        Contractbtn_3->setIconSize(QSize(110, 18));
        Contractbtn_3->setCheckable(true);
        Contractbtn_3->setAutoExclusive(true);

        verticalLayout_2->addWidget(Contractbtn_3);
...
"}"));
    ...
    void retranslateUi(QMainWindow *Admin)
    {
        ...
        SerUsage1btn_5->setText(QString());
        SerUsage1btn_6->setText(QString());
        ...
        Contractbtn_2->setText(QString());
        Contractbtn_3->setText(QString());
        ...
        CBSSUsage->setItemText(1, QCoreApplication::translate("Admin", "Room ID", nullptr));
        CBSSUsage->setItemText(2, QCoreApplication::translate("Admin", "Service Usage ID", nullptr));
